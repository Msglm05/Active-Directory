...
3. Then click on the network adapter and then go to properties, then locate Internet Protocol version 4. Here you will have the option to set up the IP Address, Subnet Mask and Default Gateway
